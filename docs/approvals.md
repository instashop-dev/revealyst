...
| Apple Developer Program + Developer ID Application cert (Desktop Agent T0.4) | developer.apple.com | **Now** — notarization lead time is the M6 long pole (rule 5) | Days (enrollment identity check) + cert issuance | ☐ requested — pending founder enrollment |
