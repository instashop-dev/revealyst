# 0003 — Connector run/dispatch hardening (adversarial-review findings)
...
ADR 0002's PR: an errored connection was permanently excluded from dispatch
...
## Decision
1. **`connections.markPolled`** (added in ADR 0002, not yet consumed outside
