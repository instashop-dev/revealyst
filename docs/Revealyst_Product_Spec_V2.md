...
| **Team** | ~$3–5 / tracked user / mo | Multi-user orgs: all connectors, full history, all scores, team benchmarks, shared-account detection (≈ $99–499/mo for a 30–100-person team). Free for ≤10 tracked users |
