...
| **Team** | $2 / tracked user / mo | Multi-user orgs: all connectors, full history, all scores, team benchmarks, shared-account detection (≈ $60–200/mo for a 30–100-person team). Free for ≤10 tracked users |
