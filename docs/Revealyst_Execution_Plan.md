...
| Stored vendor credentials compromised | High-value keys/tokens sit in Postgres | Envelope encryption via a versioned Worker-secret KEK fixed at W0-C item (5), not deferred to W3 hardening |
