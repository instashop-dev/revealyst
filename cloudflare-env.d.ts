/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 154ad29fb490ecbc25af027d3eca7669)
// Runtime types generated with workerd@1.20260701.1 2026-06-01 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	HYPERDRIVE: Hyperdrive;
	LAUNCH_EVENTS: AnalyticsEngineDataset;
	POLL_QUEUE: Queue;
	ASSETS: Fetcher;
	DATABASE_URL: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DATABASE_URL" | "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET">> {}
}
